...
$(document).ready(function() {
   ...
   $tunder.show().arctext({radius: 180, dir: -1});
	...
	function initialize() {
	    ...
	    //marker church
	    var image_church  = new google.maps.MarkerImage("../src/img/marker-church.png", null, null, null, new google.maps.Size(33,50));
	    ...
	    boxText_church.innerHTML = '<div class="grid grid_6 percentage border-white"><div class="block-focus center"><h4>Church</h4><h5>Cerimony</h5><p>12:00 PM</p></div></div><div class="grid grid_6 percentage border-white"><img class="block-focus border-white" src="../src/img/map-church.jpg"></div>';
	    ...
	    //marker restaurant
	    var image_restaurant = new google.maps.MarkerImage("../src/img/marker-restaurant.png", null, null, null, new google.maps.Size(33,50));
	    ...
	    boxText_restaurant.innerHTML = '<div class="grid grid_6 percentage border-white"><div class="block-focus center"><h4><strong>Restaurant</strong></h4><h5>PARTY</h5><p>14:00 PM</p></div></div><div class="grid grid_6 percentage border-white"><img class="block-focus border-white" src="../src/img/map-restaurant.jpg"></div>';
	    ...
	    //marker hotel
	    var image_hotel = new google.maps.MarkerImage("../src/img/marker-hotel.png", null, null, null, new google.maps.Size(33,50));
	    ...
	    boxText_hotel.innerHTML = '<div class="grid grid_6 percentage block-focus"><div class="block-focus center"><h4>Hotel</h4><h5>Sleep</h5><p><i class="icon icon-star"></i><i class="icon icon-star"></i><i class="icon icon-star"></i><i class="icon icon-star"></i><i class="icon icon-star"></i></p></div></div><div class="grid grid_6 percentage block-focus"><img class="block-focus block-focus" src="../src/img/map-hotel.jpg"></div>';
	...
	/*========== Countdown start ================*/
			...
			var ts = +new Date("December 17, 2018 12:00 GMT");
